        ...
        <div className="relative container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-primary/10 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium text-primary">Modern Workshop Platform</span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
              ...
              <Card className="p-8 hover:shadow-[var(--shadow-accent)] transition-all duration-300 hover:scale-105 bg-gradient-to-br from-card to-accent/5 border-2 border-transparent hover:border-accent/20">
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-muted-foreground">Gå med i en workshop med din unika kod och dela dina idéer.</p>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">Se alla bidrag direkt när de skapas</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">Gå med via 6-siffrig kod - inget konto krävs</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground text-sm">Fungerar perfekt på mobil, surfplatta och desktop</p>
          </div>
        </div>
      </div>
    </div>
